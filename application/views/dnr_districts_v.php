...
<div id="filter">
	...
	echo form_open('dnr_districts/view_list', $attributes);
	?>
	<fieldset>
		<legend>
...
for($x=1;$x<=53;$x++){
		...
		<input type="submit" name="surveillance" class="button"	value="View districts that did not report" />
	</fieldset>
	</form> <?php
if(isset($dnr_districts[0])){
	...
	<table class="data-table" style="margin: 0 auto">
		...
		foreach ($provinces as $province) {
			echo "<tr><td>" . $province -> Name . "</td><td></td></tr>";
			foreach ($dnr_districts as $district) {
