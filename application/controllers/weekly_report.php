...
class Weekly_Report extends MY_Controller {
	...
	public function show_interface() {
		$data = array();
		$data['settings_view'] = "weekly_report_v";
	...
	public function generate() {
		...
		$this -> generatePDF($year, $bata_buffer, $epiweek, $weekending);
	}

	function generatePDF($year, $data, $epiweek, $weekending) {
		...
		$this -> mpdf -> WriteHTML('<br/>');
		$this -> mpdf -> WriteHTML('<br/>');
		$this -> mpdf -> WriteHTML('<table><tr><td><strong><u>Key</u></strong></td></tr><tr><td><strong>DNR</strong></td><td>District did not report for this disease</td><td><strong>MM</strong></td><td>Meningococcal Meningitis</td></tr>
	...
	public function base_params($data) {
		...
		$data['quick_link'] = "weekly_report";
		$data['title'] = "System Reports";
		$data['report_view'] = "weekly_report_v";
