...
class Raw_Data extends MY_Controller {
	...
	public function export() {
		...
		if ($access_level == "district_clerk") {
			$this -> get_district_raw_data($surveillance_data_requested, $malaria_data_requested, $year, $start_week, $end_week);
		} else if ($access_level == "provincial_clerk") {
			$this -> get_province_raw_data($surveillance_data_requested, $malaria_data_requested, $year, $start_week, $end_week);
		} else if ($access_level == "national_clerk") {
			$this -> get_national_raw_data($surveillance_data_requested, $malaria_data_requested, $year, $start_week, $end_week);
		}
