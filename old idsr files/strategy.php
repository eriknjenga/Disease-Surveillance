...
<div id="ja-pathway" class="wrap">
  <div class="main">
    ...
    <strong>You are here:</strong><span class="breadcrumbs pathway"> IDSR Strategy
</span>
...
<div class="article-content"><div class="ja-innerpad">
    ...
    <p>Integrated Disease Surveillance and Response (IDSR) is a comprehensive strategy for capturing health information of communicable disease for prevention and control by linking community, health facility, district, provincial and national levels. This strategy provides for rational use of resources for disease prevention and control.</p>


<p>In an integrated system:</p>
<p>The district level is the focus for integrating surveillance functions.  This is because the district is the first level in the health system with full-time staff dedicated to all aspects of public health such as monitoring health events in the community, mobilising community action and advocating for support from national and other stakeholders resources to protect the community's health.</p>
<p>All surveillance activities are co-ordinated and streamlined.  Rather than using scarce resources to maintain separate vertical activities, resources are combined to collect information from a single focal point at each level.</p>
<p>Several activities are combined into one integrated activity and take advantage of similar surveillance functions, skills, resources and target populations. For example, surveillance activities for acute flaccid paralysis (AFP) can address surveillance needs for neonatal tetanus, measles and other diseases. Thus, health staff who routinely monitor AFP cases can also review district and health facility records for information about other priority diseases.</p>
<p>Surveillance focal points at the district, provincial and national levels collaborate with epidemic response committees at each level to plan relevant public health response actions and actively seek opportunities for combining resources.</p>
			 ...
			 <div id="ja-news">
                    ...
                    <h3 class="clearfix"><span class="right-bg clearfix"><span class="left-bg">IDSR Objectives</span></span></h3>
...
<div id="jazin" class="clearfix">
   <p>To strengthen the capacity of the health system to conduct effective surveillance activities</p>
  <p>To integrate multiple surveillance systems so that forms, personnel and resources can be used more efficiently and effectively</p>
  <p>To improve the use of information for decision making</p>
  <p>To improve the flow of surveillance information between and within levels of the health system</p>
  <p>To improve laboratory capacity in identification of pathogens and monitoring of drug sensitivity</p>
  <p>To increase the involvement of clinicians in the surveillance system.</p>
  <p>To emphasize community participation in detection and response to public health problems</p>
  <p>To strengthen the involvement of laboratory personnel in disease surveillance.</p>
</div>
</div>			</div>
    </div>
      ...
      <div id="ja-cs">
        <div class="clearfix">
          		<div class="moduletable" id="Mod32">
						<h3 class="clearfix"><span class="right-bg clearfix"><span class="left-bg">INFORMATION FLOW IN IDSR</span></span></h3>
						<div class="ja-box-ct clearfix">
			<p><img src="images/info.png" width="635" height="500" alt="Information Flow" /></p>
...
<li>Evaluation and Improvement of the system</li>
			...
			<div class="ja-tabswrap quartz" style="width:100%;">	<div id="myTab-1852520348" class="container">	<div class="ja-tabs-title-top" style="height:30px;">			
							...
							<div class="ja-tab-subcontent"><table width="100%" class="moduletable"><tbody><tr valign="top"><td align="left"><a href="#">HEAD&cedil; </a></td></tr><tr valign="top">
                              ...
                              <tr valign="top"><td align="left"><a href="www.ehealth.or.ke">To the Nearest Health Facility.</a></td></tr></tbody></table>  </div>
