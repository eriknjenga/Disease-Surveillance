...
<div id="site-wrapper">
	...
	<div id="header">
		...
		<div class="navigation" id="sub-nav">
			...
			<ul class="tabbed">
                            <li><a href="districts_submission_list.php">Home</a></li>
				
				<li><a href="districts_submission_list.php">Submissions List</a></li>
				<li><a href="districts_weekly_reports.php">Weekly Epidemiological Bulletin </a></li>
				<li><a href="districts_dashboard.php">Dashboard </a></li>
	...
	<div class="left sidebar" id="sidebar">
		<div class="section">
				...
				<div class="section-content">
					...
					<ul class="nice-list">
					<li><a href="add_district_weekly.php"<strong>Add Weekly Data</strong </a></li>
                                        <li><a href="addfacility.php">&nbsp;Add Facility</a></li>
					<li><a href="facility_change_password.php">&nbsp;Change Password</a></li>
					<li>&nbsp;</li>
					<li>&nbsp;</li>
					<li>&nbsp;</li>
					</ul>
