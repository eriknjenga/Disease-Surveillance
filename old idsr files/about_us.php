...
<div id="ja-pathway" class="wrap">
  <div class="main">
    ...
    <strong>You are here:</strong><span class="breadcrumbs pathway"> About Us
</span>
...
<div class="img-desc clearfix">
    ...
    <h2 class="contentheading">
  		...
  		About DDSR in Kenya  	</a>
  	  </h2>
      <p>The Ministry of Health developed the Kenya Health Policy Framework of 1994 that defined the priority packages, which included the communicable diseases. As a follow up, Kenya developed a five-year Health Sector Reform Strategic Plan in 1999, where communicable diseases control was identified as one of the priority packages for implementation within a decentralised system.</p>
    <p>In September 1998, the 48th Regional Committee for Africa met in Harare.  Through resolution AFRO/RC48/R2, Member States adopted integrated disease surveillance as a regional strategy for early detection and efficacious response to priority communicable diseases for African region. </p>

<p>Communicable diseases are the most common causes of death, disability and illness in Kenya.  While these diseases present a large threat to the well being of the Kenyan communities, there are well-known interventions that are available for controlling and preventing them.  Surveillance data will guide health personnel and the community in the decision-making needed to implement the proper strategies for disease control and lead to activities for preventing future cases.</p
>
<p>Disease surveillance is a watchful, vigilant approach to information gathering that serves to improve or maintain the health of the population. A functional disease surveillance system is essential for identifying and defining problems and taking action. District and local health teams are equipped to set priorities, plan interventions, mobilise and allocate resources and predict or provide early detection of outbreaks using surveillance data.</p>
			 ...
			 <div id="ja-news">
                    ...
                    <h3 class="clearfix"><span class="right-bg clearfix"><span class="left-bg">ORGANIZATIONAL STRUCTURE</span></span></h3>
						<div class="ja-box-ct clearfix">
			<script type="text/javascript" src="ja.news.js"></script>

<div id="jazin-wrap">

<div id="jazin" class="clearfix">
  <p>&nbsp;</p>
  <p><img src="images/organogram.jpg" width="616" height="302" alt="Organogram" /></p>
</div>
</div>			</div>
    </div>
      ...
      <div id="ja-cs">
        <div class="clearfix">
          		<div class="moduletable" id="Mod32">
						<h3 class="clearfix"><span class="right-bg clearfix"><span class="left-bg">OUR INITIATIVES</span></span></h3>
						<div class="ja-box-ct clearfix">
			<p>The Division of Disease Surveillance and Response under the Ministry of Public Health and Sanitation highly regards Working in partnership with stakeholders, public and communities
 to prevent, detect and control disease outbreaks in Kenya as a means to achieve the vision.</p>
<p>Here are some of the initiatives under the same:</p>
<ul>
<li>Partnerships with other stakeholders and partners in health have improved our logistical support for ease of effective disease surveillance and response activities across the country.</li>
<li>Various strains of influenza A virus especially the pandemic strains  pose a big risk to the general public.  Persons  who suffer from Chronic medical conditions , the  young  or persons aged over 60 years are at a greater risk of complication if infected by seasonal influenza. A vaccinne for seasonal influenza is currently available in some private institutions. </li>
<li>Partnership and collaboration with the media has strengthened information sharing with the public. Regular media briefs by the Ministry of Public Health and Sanitation informs the public on Local, Regional and Global issues likely to affect their health.</li>
<li>The health sector works in partnership with other government ministries and Non Governmental Organizations for effective response to disease outbreaks. Sensitization trainings of multi-sectoral nature build capacity and skills in surveillance at all levels to create competencies in disease prevention, detection, reporting, investigation and control.</li>
<li>Responding to disease outbreaks and other health events of public health importance is a key pillar of this division. The division has effectively responded to Polio, Pandemic influenza A/H1N1 2009, Measles, Cholera, Rift Valley Fever and other disease outbreaks.</li>
...
<li>Evaluation and Improvement of the system</li>
			...
			<div class="ja-tabswrap quartz" style="width:100%;">	<div id="myTab-1852520348" class="container">	<div class="ja-tabs-title-top" style="height:30px;">			
							...
							<div class="ja-tab-subcontent"><table width="100%" class="moduletable"><tbody><tr valign="top"><td align="left"><a href="#">HEAD&cedil; </a></td></tr><tr valign="top">
                              ...
                              <tr valign="top"><td align="left"><a href="http://ehealth.or.ke">To the Nearest Health Facility.</a></td></tr></tbody></table>  </div>
							...
							<div class="ja-tab-subcontent"><p><a href="http://www.ehealth.or.ke">To the Nearest Health Facility</a></p>  </div>
						 </div></div>	</div>
					</div>
...
<div class="main clearfix" align="center"><strong>Division of Disease Surveillance and Control</strong><br>
