			   ...
			   <table class="data-table">						
				...
				if ($_POST['save']){				
					...
					foreach($diseases as $diseaseid){
						execute("insert into surveillance(facility,disease,age,mcase,fcase,mdeath,fdeath,datecreated,createdby,datemodified,modifiedby,flag) values ('$facility','$diseaseid','2','$mcase[$i]','$fcase[$i]','$mdeath[$i]','$fdeath[$i]','$date',1,'$date',1,1)");
						$i++;
					}	
