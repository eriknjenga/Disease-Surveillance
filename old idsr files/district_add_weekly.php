                ...
                <table><tr>
                        ...
                        if ($_POST['save']) {
                            ...
                            if (mysql_num_rows($validateEntriesResult) == 0) {
                                foreach ($diseases as $diseaseid) {
                                    $sql = "INSERT INTO surveillance(disease,lmcase,lfcase,lmdeath,lfdeath,datecreated,createdby,datemodified,modifiedby,flag,epiweek,submitted,expected,facility,weekending,gmcase,gfcase,gmdeath,gfdeath,reportedby,designation,datereportedby) values ('$diseaseid','$lmcase[$i]','$lfcase[$i]','$lmdeath[$i]','$lfdeath[$i]','$date',1,'$date',1,1,'$epiweek','$submitted','$expected','$facility','$weekending','$gmcase[$i]','$gfcase[$i]','$gmdeath[$i]','$gfdeath[$i]','$reportedby','$designation','$date')";
                            ...
                            $sqltwo = "insert into lab_weekly (epiweek,weekending,district,facility,remarks,malaria_below_5,malaria_above_5,positive_below_5,positive_above_5,datecreated)values('$epiweek','$weekending','$district','0','$remarks','$totaltestedmalarials','$totaltestedmalariagr','$totalpositivemalarials','$totalpositivemalariagr','$date')";
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td ><strong>
                                            <select  style="width:262px"  id="cat" name="cat" class="validate[required]">
