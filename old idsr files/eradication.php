...
<table width="950" border="0">
  ...
  <tr>
    <td colspan="2" class="mytable_th">DISEASES TARGETED FOR ERADICATION AND ELIMINATION - Notify Immediately.</td>
    </tr>
  <tr>
  ...
  <tr>
    <td class="mytable_td3">Any case with weakness or floppiness of the limbs of sudden onset, not due to trauma in a child less than 15 yewars of age.</td>
    <td class="mytable_td3"><strong>Acute Flaccid Paralysis (AFP) Polio</strong></td>
  </tr>
  <tr>
    <td class="mytable_td3">Person with fever and maculopapular (non vesicular) generalized rash and cough, coryza or conjuctivitis (red eyes) or any person in whom a clinician suspects measles. A measles death is a death occuring within 30 days of onset rash.</td>
    <td class="mytable_td3"><strong>Measles</strong></td>
  </tr>
  <tr>
    <td class="mytable_td3">Any person with the following cardinal signs: skin patch with loss of sensation one or more enlarged nerves, and presence of leprosy bacilli with or without bacteriological diagnostic confirmation and requiring chemotherapy (excluding patients released from treatment).</td>
    <td class="mytable_td3"><strong>Leprosy</strong></td>
  </tr>
  <tr>
    <td class="mytable_td3">Any newborn with a normal ability to suck or cry during the first two days of life, and who, between 3 and 28 days of age, cannot suck normally and has generalized stiffness/or spasms.</td>
    <td class="mytable_td3"><strong>Neonatal Tetanus</strong></td>
  </tr>
  <tr>
    <td class="mytable_td3">Any person with a history of skin lesion and emergence of guinea worm within one year of the skin lesion.</td>
    <td class="mytable_td3"><strong>Dracunculiasis (Guinea Worm)</strong></td>
  </tr>
  <tr>
