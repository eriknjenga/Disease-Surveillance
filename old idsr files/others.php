...
<table width="950" border="0">
  ...
  <tr>
    <td class="mytable_td"><p class="prpl"><strong>MINOR SIGNS</strong></p>
    <div class="dv"><div id="img"></div>Persistent cough for more than 1 month</div><div class="dv"><div id="img"></div>Generalized pruritic dermatitis</div><div class="dv"><div id="img"></div>History of Herpes zoster</div>
    <div class="dv"><div id="img"></div>Oropharyngeal candidiasis</div>
    <div class="dv"><div id="img"></div>Chronic progressive or disseminated herpes virus infection</div>
    <div class="dv"><div id="img"></div>Generalized lymphadenopathy</div>
    <div class="dv"><div id="img"></div>Recurrent common infections, e.g. ear infection, pharryngitis (children)</div></td>
    <td class="mytable_td3"><strong>New AIDS Cases</strong></td>
  </tr>
  <tr>
    <td class="mytable_td3">Chronic cough (of more than three weeks) with sputum smear positive for mycobacterium tubercle.</td>
    <td class="mytable_td3"><strong>Tuberculosis</strong></td>
  </tr>
  <tr>
    <td class="mytable_td"><p class="prpl"><strong>Suspected Case</strong></p><div class="p"><div id="img"></div>Genital ulcer syndrome (non-vesicular): </div><p class="dv">Any male with an ulcer on the penis, scrotum or rectum, with or without inguinal adenopathy, or any female with ulcer on the Labia, vagina or rectum, with or without inguinal adenopathy.</p>
    <div class="p"><div id="img"></div>Urethra discharge syndrome: </div><p class="dv">Any male/female with urethra discharge with or without dysuria.</p>
    <p class="prpl"><strong>Confirmed Case</strong></p><div class="p"><div id="img"></div>Genital ulcer syndrome (non-vesicular): </div><p class="dv">Any suspected case confirmed by a diagnostic laboratory procedure.</p>
    <div class="p"><div id="img"></div>Urethral/vaginal diacharge syndrome: </div><p class="dv">Any suspected case confirmed by a diagnostic laboratory procedure method (for example Gram stain showing intracellular Gram-Negative diplococci).</p></td>
    <td class="mytable_td3"><strong>Sexually Transmitted Infections</strong></td>
  </tr>
  <tr>
