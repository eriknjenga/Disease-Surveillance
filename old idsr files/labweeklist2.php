...
$ttname=$ttdd['ttname'];
?>
	<div class="section-title">Submitted Weekly Samples for Lab Analysis </div>
...
<table class="data-table">
  ...
  <tr class="even">
    <td>1</td>
	<td> Gatunyi Dispensary</td>
    <td>&nbsp;4th February 2011</td>
    <td> <a href="surveillance2.php">View Details</a> </td>
  </tr>
  <tr class="even">
    <td>2</td>
	<td> Nagori Dispensary</td>
