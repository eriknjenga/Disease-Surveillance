...
<table width="950" border="0">
  ...
  <tr>
    <td class="mytable_td"><p class="dv">Any child less than 5 years of age with diarrhoea and two or more of the following: </p>
    <div class="dv"><div id="img"></div>Restless or irritable</div><div class="dv"><div id="img"></div>Sunken eyes</div><div class="dv"><div id="img"></div>Drinks eagerly, thirsty</div>
    <div class="dv"><div id="img"></div>Skin pinch goes back slowly</div>
    </td>
    <td class="mytable_td3"><strong>Diarrhoea with some dehydration in children less than 5 years of age</strong></td>
  </tr>
  <tr>
    <td class="mytable_td"><p class="dv">Any child aged 2 months upto 5 years of age with cough or difficult breathing and</p>
    <div class="dv"><div id="img"></div>breathing 50 breaths or more per minute in an infant 2 months upto 1 year</div><div class="dv"><div id="img"></div>breathing 40 breaths or more per minute for a child aged 1 to 5 years</div><p class="p"><i>(Infants less than 2 months with fast breathing 60 breaths or more per minute are reffered for serious bacterial infection.)</i></p></td>
    <td class="mytable_td3"><strong>Pneumonia in children less than 5 years of age</strong></td>
  </tr>
  <tr>
    <td class="mytable_td3">Any child aged 2 months upto 5 years with cough or difficult breathing, and with any general danger sign, or chest indrawing, or stridor in acalm child. General danger signs are: unable to drink or breast-feed, vomits everything, convulsions, lethargy or unconsciousness.</td>
    <td class="mytable_td3"><strong>Severe Pneumonia in children less than 5 years of age</strong></td>
  </tr>
  <tr>
    <td class="mytable_td3"><p><strong>Either: </strong>Severe acute unexplained respiratory illness with fever of <strong>&ge; 38&deg;C</strong> plus cough or sore throat and difficult in breathing.</p>
    <p><strong>Severe: </strong>Moderate -to- severe respiratory illnes: lower respiratory tract illness (temperature greater <strong>than 38&deg;C</strong>) cough, shortness of breath, or diffulty breathing with or without evidence (clinical or radiological) of pneumonia. All hospitalized cases are considered severe by definition.</p>
    <p><strong>Unexplained: </strong>clinical, epidemiological, or laboratory evaluation does not determine a cause or etiological agent, such as tuberculosis.</p>
    <p class="p"><strong>Decision to investigate influenza A/H% or SARS will depend on:</strong></p>
    <div class="dv"><div id="img"></div>Clinical presentation</div>
    <div class="dv"><div id="img"></div>Contact with a person with unexplained acute respiratory illness that later resulted in death.</div></td>
