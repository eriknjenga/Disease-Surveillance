...
<div id="ja-pathway" class="wrap">
  <div class="main">
    ...
    <strong>You are here:</strong><span class="breadcrumbs pathway"> Resources
</span>
...
<div class="img-desc clearfix">
    ...
    <div id="container">
		<ul class="menu">
			<li id="news" class="active">Resources</li>
</ul>
  ...
  <tr>
    <td width="69%">Case Based Surveillance Form</td>
    <td width="14%"><a href="Resources/MOH502.doc"><img src="images/word.png" width="32" height="32" alt="Word" /></a></td>
    <td width="17%"><a href="Resources/MOH502.pdf"><img src="images/pdf.png" width="32" height="32" alt="PDF" /></a></td>
  </tr>
  <tr>
    <td>Health Facility Line Listing Form</td>
    <td width="14%"><a href="Resources/MOH503.doc"><img src="images/word.png" width="32" height="32" alt="Word" /></a></td>
    <td width="17%"><a href="Resources/MOH503.pdf"><img src="images/pdf.png" width="32" height="32" alt="PDF" /></a></td>
  </tr>
  <tr>
    <td>Monthly Surveillance Form</td>
    <td width="14%"><a href="Resources/MOH504.doc"><img src="images/word.png" width="32" height="32" alt="Word" /></a></td>
    <td width="17%"><a href="Resources/MOH504.pdf"><img src="images/pdf.png" width="32" height="32" alt="PDF" /></a></td>
  </tr>
  <tr>
    <td>Weekly Epidemic Monitoring Form</td>
    <td width="14%"><a href="Resources/MOH505.doc"><img src="images/word.png" width="32" height="32" alt="Word" /></a></td>
    <td width="17%"><a href="Resources/MOH505.pdf"><img src="images/pdf.png" width="32" height="32" alt="PDF" /></a></td>
  </tr>
  <tr>
    <td>Online Job Training Facilitator's Guide</td>
    <td width="14%"><a href="Resources/OJT.doc"><img src="images/word.png" width="32" height="32" alt="Word" /></a></td>
    <td width="17%"><a href="Resources/OJT.pdf"><img src="images/pdf.png" width="32" height="32" alt="PDF" /></a></td>
  </tr>
  <tr>
    <td>IDSR Technical Guidelines</td>
    <td width="14%"><a href="Resources/TECHNICAL.doc"><img src="images/word.png" width="32" height="32" alt="Word" /></a></td>
    <td width="17%"><a href="Resources/TECHNICAL.pdf"><img src="images/pdf.png" width="32" height="32" alt="PDF" /></a></td>
  </tr>
  <tr>
    <td>Kenya Polio Documentation Report</td>
    <td width="14%"><a href="Resources/POLIO.doc"><img src="images/word.png" width="32" height="32" alt="Word" /></a></td>
    <td width="17%"><a href="Resources/POLIO.pdf"><img src="images/pdf.png" width="32" height="32" alt="PDF" /></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
   <td width="14%">&nbsp;</td>
...
if($i % 2 == 0)
		{
			...
			echo "</td>";
			echo "<td style='background-color:#fff'>";
			echo "Bulletin for Epiweek ".($i+10);
			echo "<a style='text-decoration : none;' href='Bulletins/2011/".($i+10). ".pdf'>&nbsp;<img src='images/down.png' alt='Download' /></a>"; 
			echo "</td>";
			echo "</tr>";
		}
		else
