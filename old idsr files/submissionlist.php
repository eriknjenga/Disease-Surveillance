<html>
	...
	<div  class="section">
		<div class="section-title" align="center">
			<strong>SUBMISSIONS LIST  FOR EPI WEEK <?php echo $lastepiweek;?></strong>
		</div>
		<div align="center">
		...
		<div id="draggable" class="section" align="center">
			<table class="data-table">
				...
				<tr class="even">
					<td colspan="28"><?php echo '<strong>' . $tname . '</strong>';?></td>
				</tr>
				<?php
				$below = 0;
				//totals of people below or equal 5 years
				$above = 0;
				//totals of people above 5 years
