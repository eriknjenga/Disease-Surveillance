...
<table width="950" border="0">
  ...
  <tr>
    <td rowspan="2" class="mytable_td">Alert Threshold</td>
    <td class="mytable_td1"><strong>Cholera</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="mytable_td3">If a suspect is confirmed</td>
  </tr>
  <tr>
    <td rowspan="2" class="mytable_td3">Alert Threshold</td>
    <td class="mytable_td1"><strong>Typhoid Fever</strong></td>
  </tr>
  <tr>
    <td class="mytable_td2">Observed increase in number of cases or deaths over a period of time</td>
  </tr>
  <tr>
    <td class="mytable_td2">Action Threshold</td>
    <td class="mytable_td3">Observed above alert with at least one case confirmed by culture</td>
  </tr>
  <tr>
    <td rowspan="2" class="mytable_td3">Alert Threshold</td>
    <td class="mytable_td1"><strong>Dysentry (Diarrhoea with blood)</strong></td>
  </tr>
  <tr>
    <td class="mytable_td2">Observed increase in number of cases or deaths over a period of time</td>
  </tr>
  <tr>
    <td class="mytable_td2">Action Threshold</td>
    <td class="mytable_td2">Observed above alert with at least one case confirmed by culture</td>
  </tr>
  <tr>
    <td rowspan="2" class="mytable_td3">Alert Threshold</td>
    <td class="mytable_td1"><strong>Diarrhoea with dehydration in children less than 5 years of age.</strong></td>
  </tr>
  <tr>
    <td class="mytable_td2">Observed increase in number of cases or deaths over a period of time</td>
  </tr>
  ...
  <tr>
    <td rowspan="2" class="mytable_td3">Alert Threshold</td>
   <td class="mytable_td1"><strong>Dracunculiasis</strong></td>
  </tr>
  <tr>
    <td class="mytable_td2">If a single case is suspected</td>
  </tr>
  <tr>
    <td class="mytable_td2">Action Threshold</td>
    <td class="mytable_td3">If the single case is confirmed by the emergence of a guinea worm from a skin lesion</td>
  </tr>
  <tr>
    <td rowspan="2" class="mytable_td3">Alert Threshold</td>
    <td class="mytable_td1"><strong>Leprosy</strong></td>
  </tr>
  <tr>
    <td class="mytable_td2">If a single case is suspected.</td>
  </tr>
  <tr>
    <td class="mytable_td2">Action Threshold</td>
    <td class="mytable_td3">If a suspected case is confirmed</td>
  </tr>
  <tr>
    <td rowspan="2" class="mytable_td3">Alert Threshold</td>
    <td class="mytable_td1"><strong>Malaria</strong></td>
  </tr>
  <tr>
    <td class="mytable_td2"><p>Malaria alert threshold is attained when the number of weekly malaria cases observed crosses above the THIRD QUARTILE level for the last 5 years. When computing the Alert thresholds, it is not necessary to exclude epidemic years as quartiles and percentiles are not affected by extreme observations.</p><p>An ALERT threshold indicates that there is possible malaria upsurge and need for confirmation through investigations is needed.</p>
    </td>
  </tr>
  <tr>
    <td class="mytable_td2">Action Threshold</td>
    <td class="mytable_td3"><p>Malaria ACTION threshold is attained when there is a steady increase of weekly Malaria cases observed above the Mean + 1.55SD (Standard Deviation) level for the last 5 years</p><p>When computing Action thresholds, it is important to extreme observations. An ACTION threshold indicates there is serious malaria upsurge to epidemic proportions. The district epidemic team need to initiate outbreak investigations and effect control measures.</p></td>
  </tr>
  <tr>
    <td rowspan="2" class="mytable_td3">Alert Threshold</td>
    <td class="mytable_td1"><strong>Measles</strong></td>
  </tr>
  <tr>
    <td class="mytable_td2">If 5 or more cases of suspected measles in a district in a month are reported, an outbreak is suspected.</td>
  </tr>
  <tr>
    <td class="mytable_td2">Action Threshold</td>
    <td class="mytable_td3">If 3 or more cases are laboratory confirmed as lgM positive cases in a district in a month, an outbreak is reported.</td>
  </tr>
