...
<table width="950" border="0">
  ...
  <tr>
    <td class="mytable_th">Kenya's Integrated Disease Surveillance and Response (IDSR) for Priority Diseases</td>
  </tr>
  <tr>
    <td class="mytable_td"><p>
    The Ministry of Public Health and Sanitation Kenya identified 18 Communicable diseases and conditions for IDSR. The Criteria for selection used;</p>
<div class="list"><div id="img"></div>Are top causes of high morbidity and mortality in Kenya (for example Malaria, Pneumonia, diarrhoeal diseases, TB and HIV/AIDS).</div>
<div class="list"><div id="img"></div>Have epidemic potential (for example cholera, Measles, meningococcal menengitis and yellow fever).</div>
<div class="list"><div id="img"></div>Surveillance required Internationally (for example Polio, Yellow fever and cholera)</div>
<div class="list"><div id="img"></div>Have national intervention programmes for prevention and control, eradication and elimination of the diseases (for example Polio and NNT)</div>
<div class="list"><div id="img"></div>Can easily be identified using simple case Definitions</div>
<p>In an IDSR system, surveillance activities and resources are coordinated and streamlined. A focal person at each level of a health system collects surveillance information on priority infectious diseases, and reports this information to the next level. A country uses this surveillance information as a rational basis to make decisions and to plan public health interventions in response to priority infectious diseases.</p></td>
  </tr>
  <tr>
    <td class="mytable_th">Our Vision and mission</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="mytable_td"><div class="list"><div id="img"></div>Case detection. </div>
    <div class="list"><div id="img"></div>Case registration and
reporting. </div>
    <div class="list"><div id="img"></div>Lab Confirmation. </div>
    <div class="list"><div id="img"></div>Data analysis and
interpretation. </div>
    <div class="list"><div id="img"></div>Response. </div>
    <div class="list"><div id="img"></div>Provide feedback. </div>
    <div class="list"><div id="img"></div>Evaluate and improve
the system. </div></td>
  </tr>
</table></div>
</td>
